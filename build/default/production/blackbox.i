...
void dashboard()
{
    ...
    else if(key==3 && i!=7 && delay<1)
    {
        i=7;
        event_capture();
    }
    clcd_print(gear[i],(0xC0 + (10)));
    clcd_putch(speed_val/10+'0',(0xC0 + (14)));
    clcd_putch(speed_val%10+'0',(0xC0 + (15)));
...
void authorisation(void)
{
    ...
    else if (count == 4)
    {
        ...
        else
        {
            ...
            {
                clcd_print("INCORRECT PASS", (0x80 + (0)));
                clcd_print("ATTEMPT LEFT - ", (0xC0 + (0)));
                clcd_putch(attempt + '0', (0xC0 + (15)));
            }
            clcd_write(0x01, 0);
            count = 0;
        }
    ...
    if (attempt == 0)
    {
        ...
        clcd_putch((sec % 10) + '0', (0xC0 + (3)));
        clcd_putch(((sec / 10) % 10) + '0', (0xC0 + (2)));
        clcd_putch((sec / 100) + '0', (0xC0 + (1)));
    }
...
void disp_menu()
{
    ...
    clcd_print(menu[main_count],(0x80 + (1)));
    clcd_print(menu[main_count+1],(0xC0 + (1)));
    if(key==13)
    {
        if(star_flag==0)
        {
...
void view_log()
{
    ...
    if(no_event==0)
    {
        ...
        {
            clcd_print("No events found",(0x80 + (0)));
        }
        main_flag=1;
        clcd_write(0x01, 0);
    }
    else
    {
        ...
        clcd_print("LOGS", (0x80 + (5)));
        clcd_putch(log_count + 48, (0xC0 + (0)));
        clcd_print(" ", (0xC0 + (1)));
        for (int j = 2; j < 10; j++)
        {
            if (j == 4 || j == 7)
            ...
            else
            {
                ...
                clcd_putch(data, (0xC0 + (j)));
            }
        }
        clcd_print("  ", (0xC0 + (10)));
        data = read_24c02(view_addr++);
        clcd_putch(data, (0xC0 + (11)));
        data = read_24c02(view_addr++);
        clcd_putch(data, (0xC0 + (12)));
        clcd_print("  ", (0xC0 + (13)));
        data = read_24c02(view_addr++);
        clcd_putch(data, (0xC0 + (14)));
        data = read_24c02(view_addr++);
        clcd_putch(data, (0xC0 + (15)));
        if (key == 11 && (log_count > 0))
        {
            line1--;
            log_count--;
        }
        if (key == 12 && (log_count < no_event))
        {
            line1++;
            log_count++;
        }
...
void download_log()
{
    ...
    else
    {
        ...
        {
            clcd_print("DOWNLOADING", (0x80 + (3)));
            clcd_print("LOGS...", (0xC0 + (3)));
        }
        ...
        for(unsigned int i=0;i<4000;i++);
        {
            clcd_print("DOWNLOAD DONE", (0x80 + (1)));
        }
        clcd_write(0x01, 0);
    }
}
...
void clear_log()
{
    ...
    for(unsigned int i=0;i<4000;i++)
    {
        clcd_print("Logs deleted",(0x80 + (0)));
    }
    clcd_write(0x01, 0);
}
